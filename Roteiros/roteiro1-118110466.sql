...
ALTER TABLE SEGURADO ADD CONSTRAINT FOREIGN KEY(numero_do_chassi) REFERENCES AUTOMOVEL(numero_do_chassi);
ALTER TABLE OFICINA ADD CONSTRAINT FOREIGN KEY(numero_do_chassi)REFERENCES AUTOMOVEL(numero_do_chassi); 
ALTER TABLE SEGURO ADD CONSTRAINT FOREIGN KEY(cpf_segurado) REFERENCES SEGURADO(cpf_segurado);
ALTER TABLE SEGURO ADD CONSTRAINT FOREIGN KEY(numero_do_chassi) REFERENCES AUTOMOVEL(numero_do_chassi);;
ALTER TABLE SINISTRO ADD CONSTRAINT FOREIGN KEY(numero_do_chassi) REFERENCES AUTOMOVEL(numero_do_chassi);;  
ALTER TABLE PERICIA ADD CONSTRAINT FOREIGN KEY(cpf_perito) REFERENCES PERITO(cpf_perito);
ALTER TABLE PERICIA ADD CONSTRAINT FOREIGN KEY(id_sinistro) REFERENCES SINISTRO(id_sinistro);   
ALTER TABLE REPARO ADD CONSTRAINT FOREIGN KEY(cnpj_oficina) REFERENCES OFICINA(cnpj_oficina); 
ALTER TABLE REPARO ADD CONSTRAINT FOREIGN KEY(numero_do_chassi) REFERENCES AUTOMOVEL(numero_do_chassi);; 
